...
<section class="m-components">
	<h2 class="a-components__sectiontitle">Add fancy loadingeffects: <code>gridViewEffects();</code> hook with <code>.js-medialoadEffect</code> on parent element.</h2>
	<div class="o-gridview js-medialoadEffect">
	
		<div class="m-gridview__item">
			<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/component_demo_imgs/image7.png" alt="" />
		</div>
		<div class="m-gridview__item">
			<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/component_demo_imgs/image7.png" alt="" />
		</div>
