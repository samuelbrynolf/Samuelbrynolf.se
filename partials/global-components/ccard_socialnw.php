<?php if(function_exists('get_field')) { ?>
    ...
    <ul class="l-container a-fineprint m-ccard__list">
        ...
        <?php if(get_field('options_ccard_snw_githubLabel', 'option') && get_field('options_ccard_snw_githubUrl', 'option')) { ?>
            <li class="l-span-A12 l-span-C4"><a class="a-icon github" href="<?php echo get_field('options_ccard_snw_githubUrl', 'option'); ?>" title="Samuel Brynolf p&aring; Github" rel="me"><?php echo get_field('options_ccard_snw_githubLabel', 'option'); ?></a></li>
        <?php } ?>
        ...
        <?php if(get_field('options_ccard_snw_staticLabel', 'option') && get_field('options_ccard_snw_staticUrl', 'option')) { ?>
            <li class="l-span-A12 l-span-C4"><a class="a-icon aventyret" href="<?php echo get_field('options_ccard_snw_staticUrl', 'option'); ?>" title="Samuel Brynolf jobbar p&aring; &Auml;ventyret" rel="me"><?php echo get_field('options_ccard_snw_staticLabel', 'option'); ?></a></li>
        <?php } ?>
        ...
        <?php if(get_field('options_ccard_snw_phoneLabel', 'option')){ ?>
            <li class="l-span-A12 l-span-C4"><span class="a-icon phone"><?php echo get_field('options_ccard_snw_phoneLabel', 'option'); ?></span></li>
        <?php } ?>
    </ul>
